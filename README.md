...
As for the project requirements I need to mention the number of commits. This repository only has a few commits, all of which are recent. This is because I was originally using "Upload a file" to save my project instead of pushing through the command line. You can find the previous commits in my "Make-a-Scale" repository.
